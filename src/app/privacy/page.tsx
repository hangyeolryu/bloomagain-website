    ...
    >
      ...
      <section id="section-2">
        ...
        <ol>
          ...
          <li>
            <strong>문의 접수 및 응대</strong>: 이용자가 웹사이트(tita-app.com) 문의 폼 또는 앱 내 문의 채널을 통해 남긴 문의에 회신하기 위한 목적. 회신 완료 후에는 보관하지 않습니다.
          </li>
        </ol>
      </section>
      ...
      <section id="section-3">
        ...
        <ol>
          ...
          <li>
            <strong>문의 시 수집 항목</strong>: 회신받으실 이메일 주소 또는 휴대폰 번호, 문의 내용, 성함(선택). 가입하지 않은 이용자도 웹사이트 문의 폼을 이용할 수 있으며, 이때 수집되는 항목은 위 항목에 한합니다. <strong>문의 응대 외의 목적(마케팅 발송 등)으로 사용하지 않습니다.</strong>
          </li>
          <li>
      ...
      <section id="section-4">
        ...
        <ol>
          ...
          <li><strong>문의 내역(연락처·문의 내용)</strong>: 응대 완료 후 지체 없이 파기합니다. 다만 분쟁 대응 등 정당한 사유가 있는 경우 최대 3년(전자상거래법상 소비자 불만·분쟁 처리 기록 보존 기간) 보관 후 파기합니다.</li>

    ...
    >
      ...
      <section id="section-2">
        ...
        <ol>
          ...
          <li>
            <strong>연구 및 통계 활용 (선택)</strong>: 익명화된 집계 데이터를 활용한 학술 논문 publish, 국립정신건강센터·보건복지부 등 공공 기관과의 정책 연구 협력, 한국 45+ 세대 디지털·정서·사회 연결 종단 데이터셋 구축. 개인 식별 정보는 학술 publish에 포함되지 않습니다.
          </li>
          <li>
